...
class Logger {
  constructor({ loggerOptions, replaceInFilesMainOptions }) {
    ...
    this.setMatchs = this.setMatchs.bind(this);
  ...
  setEventListeners() {
    ...
    helpers.eventEmitter.on(SAVE_MATCHES,this.setMatchs);
  }
  ...
  removeEventListeners() {
    ...
    helpers.eventEmitter.removeListener(SAVE_MATCHES, this.setMatchs);
  }
